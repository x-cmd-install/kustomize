...
[![x-cmd/install — kustomize Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/kustomize.svg?lang=zh)](https://x-cmd.com/install/kustomize)
...
合计: **152,588** 行代码（覆盖前 5 种语言、共 **1068** 个文件）。
...
- **上游仓库**: <https://github.com/kubernetes-sigs/kustomize>
- **许可证**: Apache-2.0
...
- **Star**: 12,170 · **Fork**: 2,425 · **开放 issue**: 2,525 · **贡献者**: 823

## 累计统计

- **发布数**: 280 · **已合并 PR**: 2934 · **开放 PR**: 51 · **已关闭 issue**: 2388 · **开放 issue**: 137 · **提交数**: 7172

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 22 | 14 | 3 | 2 | 24 |
| last60d | 2026-07-27 | 0 | 28 | 18 | 7 | 4 | 30 |
| 90d | 2026-06-27 | 0 | 38 | 25 | 9 | 5 | 43 |
| last180d | 2026-03-29 | 0 | 49 | 37 | 18 | 12 | 54 |
| 360d | 2025-09-30 | 8 | 79 | 46 | 43 | 28 | 94 |
| last720d | 2024-10-05 | 25 | 141 | 51 | 119 | 40 | 299 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/kustomize.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:03:01Z._
